 ...
 *
 */
class EducationFragment : KodeinSupportFragment(), BaseAdapter.OnClickListener {
    private val TAG: String = EducationFragment::class.simpleName!!

    private val aboutApiService: AboutApiService by instance()
    private var disposableResults: Disposable? = null

    private var dataSet: MutableList<Education> = mutableListOf()
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        val adapter = EducationAdapter(dataSet, 4)
        ...
        disposableResults = aboutApiService.getAllEducation()
    ...
    private fun onNewResults(search: EducationSearchResults) {
    ...
    companion object : FragmentInstancer {
        override fun newInstance(): EducationFragment {
